...
- Create Angular project with ng: `ng new mouldremediation.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mouldremediation.client.esproj`).
